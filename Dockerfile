FROM davidmontaine/glassfish
ENV DOMAIN_DIR ${GLASSFISH_HOME}/domains/domain1
RUN curl -o ${DOMAIN_DIR}/lib/mariadb-java-client-2.4.1.jar -L https://downloads.mariadb.com/Connectors/java/connector-java-2.4.1/mariadb-java-client-2.4.1.jar
#COPY cacerts.jks ${DOMAIN_DIR}/config
